...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1329854734').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002951884131').split()]  # For Multiple Id Use One Space Between Each.
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002205238844')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Kf_Movies7') # Support Chat Link Without https:// or @
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/KF_Links/231') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
